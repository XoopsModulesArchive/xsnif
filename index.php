...
while($row = mysql_fetch_array($result))
  ...
  $hidden_files_wildcards = explode("|", $row['hidden_files_wildcards']);
  ...
  $display_columns = explode("|", $row['display_columns']);
 ...
 **/
$allowPHPDownloads = $allow_php_downloads;
 ...
 **/
$useAutoThumbnails = $use_auto_thumbnails;
 ...
 * manually.
 **/
$cacheThumbnails = $cache_thumbnails;
 ...
 **/
$externalStylesheet = $external_stylesheet;
 ...
 **/
$useBackForDirUp = $use_back_for_dir_up;
...
$languageStrings = Array(
	"en" => Array(
		...
		"description" => "thumbnail", // column name in the file listing
	...
	"cz" => Array(
		"Index of" => "Vpis", // displayed in the page title
		"name" => "jmno", // column name in the file listing
		...
		"DATEFORMAT" => $snifDateFormat, // special string, sets the format of the date (see http://www.php.net/manual/en/function.date.php)
		"folder" => "adresr", // a folder in the file listing
		"archive" => "archiv", // an archive file in the file listing
		"image" => "obrzek", // an image file in the file listing
		"text" => "text", // a text file in the file listing
		"HTML" => "html", // an archive file in the file listing
		"unknown" => "nezm", // an unknown file in the file listing
		"valid" => "platn", // used for "valid XHTML, valid CSS"
		"binary" => "binrn", // a binary file
		"dirup" => "nahoru", // tooltip of the .. folder icon
		"download" => "sthnout", // tooltip of the download icon to the left
		...
		"1 item" => "1 poloka", // displayed when a subdirectory contains exactly one file or directory
		"%d items" => "%d poloky", // 0 items, 42 items; displays the number of files and directories in a subdirectory. Leave %d as it is.
		"%s is not a subdirectory of the current directory." => "%s nen podaresr toho adresre", // leave %s as it is, it is replaced by the directory name
		...
		"pages" => "strnky", // as in "4 pages"
		"previous" => "predchoz", // as in "previous page"
		"next" => "nsledujc" // as in "next page"
	),
