...
<table width="100%" border="0">
  <tr>
    <td bgcolor="#CCCCCC"><div align="right"><strong>Xoops S.N.I.F</strong>. </div></td>
  ...
  <tr>
    ...
    <td>
        ...
        <select name="use_paging">
          <option value="<?php echo $use_paging; ?>" selected="selected">currently set to <?php echo $use_paging; ?></option>
...
False</label></td>
  ...
  <tr>
    <td><p>Determines which columns to display and in which order.
      ...
      <p> Example: download|icon|name|type|size|date|description</p>
